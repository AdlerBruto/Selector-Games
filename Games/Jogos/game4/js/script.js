...
const questions = [
  {
    question: "1. Dentro de qual elemento HTML colocamos o JavaScript?",
    answers: [
  ...
  {
    question: "2. Onde é o lugar correto para inserir JavaScript?",
    answers: [
  ...
  {
    question:
      '3. Qual é a sintaxe correta para se referir a um script externo chamado "xxx.js"',
    answers: [
  ...
  {
    question: "4. O arquivo JavaScript externo deve conter a tag <script>",
    answers: [
  ...
  {
    question: '5. Como escrever "Hello World" numa caixa de alerta?',
    answers: [
  ...
  {
    question: "6. Como podemos criar uma função no JavaScript?",
    answers: [
